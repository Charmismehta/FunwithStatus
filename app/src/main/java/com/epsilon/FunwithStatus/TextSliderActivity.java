...
public class TextSliderActivity extends BaseActivity {
    Activity activity;
    ViewPager pager;
...
//        loadNativeAd();
        ...
        if (name.equalsIgnoreCase("HOME")) {
            TextTrensliderAdapter adapter = new TextTrensliderAdapter(getActivity(), position);
            ...
            TextSlideAdapter adapter = new TextSlideAdapter(getActivity(), position);
            pager.setAdapter(adapter);
            pager.post(new Runnable() {
                @Override
                public void run() {
